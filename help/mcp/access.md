---
title: Cx Enterprise MCP ツールへのアクセス
description: Adobe CX Enterprise MCP ツールを使用する前に、製品の可用性、組織のイネーブルメント、権限を確認します。
...
# Cx Enterprise MCP ツールへのアクセス {#mcp-access}
...
Betaまたは限定リリースの製品ツールの場合は、Adobe アカウント担当者に連絡し、使用するAdobe for CX Enterprise MCP製品ツールを指定します。 担当者は、製品のイネーブルメントを調整し、Adobeの準備が整ったことを確認します。
...
次：[CX Enterprise MCP](install.md)用Adobeをインストールします。