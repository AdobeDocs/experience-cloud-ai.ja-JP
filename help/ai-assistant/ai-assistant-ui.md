...
>[!IMPORTANT]
>
>このドキュメントは、AI アシスタント（次世代）に適用されます。 AI アシスタント（レガシー）について詳しくは、Adobe Experience Platform ドキュメントの [AI アシスタント UI ガイド ](https://experienceleague.adobe.com/ja/docs/experience-platform/ai-assistant/home) を参照してください。
