...
エンドユーザーがAdobe Marketing Agentを使用できるのは、[!DNL Microsoft 365] テナントで使用できるようになった後だけです。**[!DNL Microsoft 365] Copilot管理者** （または組織内のCopilot エージェントの同等の管理者）と連携して、アクセスを有効にし、組織が必要とするエージェントを割り当てます。
