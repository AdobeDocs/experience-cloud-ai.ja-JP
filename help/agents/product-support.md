...
>[!AVAILABILITY]
>
>**期間限定アクセス**：製品サポートエージェントをご利用いただければ幸いです。 この機能へのアクセスは、2026 年 2 月 28 日に終了します。 引き続きプロダクトサポートエージェントをご利用になる場合は、Adobe アカウント担当者に連絡して、プロダクトサポートエージェントのライセンスについて詳しくお問い合わせください。
